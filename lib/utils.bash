...
GH_REPO="https://github.com/bjyoungblood/asdf-plugin-nerves-toolchain"
TOOL_NAME="nerves-toolchain"
TOOL_TEST="nerves-toolchain --help"
...
download_release() {
	...
	# TODO: Adapt the release URL convention for nerves-toolchain
